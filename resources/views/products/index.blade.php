...
@section('content')
    ...
    <div id="kt_app_content" class="app-content flex-column-fluid" style="display: none;">
    ...
    <style type="text/css">
        ...
        .card .card-header .card-toolbar :not(.btn:last-child) {
            border-radius: 0;
        }

        .card .card-header .card-toolbar .btn:last-child {
            border-bottom-left-radius: 0;
            border-bottom-right-radius: 0;
            border-top-left-radius: 0;
        }

        .card .card-header .card-toolbar .btn .mdi {
            line-height: 0;
        }
    ...
    <div class="card card-flush py-0 mx-5">
    <!--begin::Card header-->
        <div class="card-header mb-10">
            <div class="card-title">
                <span class="card-icon">
                    <i class="mdi mdi-cube fs-2x"></i>
                </span>
                <h2>Products</h2>
            </div>
            <div class="card-toolbar">
                <button type="button" class="btn btn-sm btn-success btn-icon-white btn-text-white">
                    <span class="mdi mdi-content-save fs-3x"></span>
                    <br>
                    Save
                </button>
                <button type="button" class="btn btn-sm btn-danger btn-icon-white btn-text-white">
                    <span class="mdi mdi-close-thick fs-3x"></span>
                    <br>
                    Close
                </button>
            </div>
